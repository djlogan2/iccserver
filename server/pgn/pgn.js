...
function id(x) { return x[0]; }
 ...
 var grammar = {
    ...
    {"name": "game", "symbols": ["tagsection", "__", "movetextsection"], "postprocess":  ([ts, _1, mt]) => {
    ...
    {"name": "tagvalue", "symbols": [(lexer.has("STRING") ? {type: "STRING"} : STRING)], "postprocess": ([tv]) => tv.value},
    ...
    {"name": "elementsequence", "symbols": ["elementsequence$subexpression$1"], "postprocess":  ([[[[[what, value]]], _, es]]) => {
