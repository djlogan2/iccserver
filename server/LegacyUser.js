        ...
        packets.level2Packets.forEach(function(p){
            ...
            switch(parseInt(p2.shift())) {
                ...
                case L2.MSEC:
                    ...
                    RealTime.update_game_clock(self.user._id, p2[1].toLowerCase(), parseInt(p2[2]), p2[3] === '1');
                    break;
                ...
                case L2.STARTED_OBSERVING:
                    RealTime.game_start(self.user._id, null, p2[1], parseInt(p2[12]), p2[2], parseInt(p2[13]), null);
