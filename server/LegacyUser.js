        ...
        packets.level2Packets.forEach(function(p){
            ...
            switch(parseInt(p2.shift())) {
                ...
                case L2.LOGIN_FAILED: /* login_failed */
                    //RealTime.send(self.user._id, 'legacy_error', {type: 'login_failed', reason: parseInt(p2[0]), text: p2[1] });
                    break;
                ...
                case L2.SEND_MOVES:
                    ...
                    RealTime.game_moveOnBoard(self.user._id, p2[1], p2[2], p2[4]);
                    break;
                case L2.STARTED_OBSERVING:
                    RealTime.game_start(self.user._id, null, p2[1], parseInt(p2[12]), p2[2], parseInt(p2[13]), parseInt(p2[6]), parseInt(p2[8]), null);
                ...
                case L2.MOVE_LIST:
                    ...
                    p2.forEach(move => {
                        let mm = move.split(' ');
                        RealTime.game_moveOnBoard(self.user._id, mm[0], mm[1], mm[3]);
                    });
                ...
                default:
                    RealTime.send_error(self.user._id,{type: 'unknown_packet', packet: p});
