...
class Game {
  ...
  startLegacyGame(
    ...
    const whiteuser = Meteor.users.findOne({ "profile.legacy.username": whitename, "profile.legacy.validated": true });

    const blackuser = Meteor.users.findOne({ "profile.legacy.username": blackname, "profile.legacy.validated": true });
    ...
    if (!self || (!iswhite && !isblack))
      throw new ICCMeteorError(message_identifier, "Unable to start legacy game", "Unable to find user");
...
//
  localUnobserveAllGames(message_identifier, user_id, server_command, due_to_logout) {
    ...
    GameCollection.find(
      ...
      "server", game._id, user_id, server_command, due_to_logout));
  }
...
Meteor.methods({
  ...
  addGameMove: global._gameObject.saveLocalMove,
  requestTakeback: global._gameObject.requestLocalTakeback,
  acceptTakeBack: global._gameObject.acceptLocalTakeback,
  declineTakeback: global._gameObject.declineLocalTakeback,
  resignGame: global._gameObject.resignLocalGame,
  requestToDraw: global._gameObject.requestLocalDraw,
  acceptDraw: global._gameObject.acceptLocalDraw,
  declineDraw: global._gameObject.declineLocalDraw,
  requestToAbort: global._gameObject.requestLocalAbort,
  acceptAbort: global._gameObject.acceptLocalAbort,
  declineAbort: global._gameObject.declineLocalAbort,
  requestToAdjourn: global._gameObject.requestLocalAdjourn,
  acceptAdjourn: global._gameObject.acceptLocalAdjourn,
  declineAdjourn: global._gameObject.declineLocalAdjourn,
  drawCircle: global._gameObject.drawCircle,
  removeCircle: global._gameObject.removeCircle,
  startLocalExaminedGame: global._gameObject.startLocalExaminedGame,
  moveBackward: global._gameObject.moveBackward,
  moveForward: global._gameObject.moveForward,
  searchGameHistory: GameHistory.search,
  examineGame: GameHistory.examineGame,
  clearBoard: global._gameObject.clearBoard,
  setStartingPosition: global._gameObject.setStartingPosition,
  loadFen: global._gameObject.loadFen,
  addPiece: global._gameObject.addPiece,
  removePiece: global._gameObject.removePiece,
  setToMove: global._gameObject.setToMove,
  setCastling: global._gameObject.setCastling,
  setEnPassant: global._gameObject.setEnPassant,
  setTag: global._gameObject.setTag,
  changeOwner: global._gameObject.changeOwner,
  setPrivate: global._gameObject.setPrivate,
  allowRequests: global._gameObject.allowRequests,
