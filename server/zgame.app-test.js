...
describe("Game.startLocalGame", function(){
    ...
    it("should error out if the user is starting an unrated game and their opponent cannot play unrated games", function(){chai.assert.fail("do me")});
    //  self,
    it("should error out if self is null", function(){chai.assert.fail("do me")});
    it("should error out user is neither white nor black", function(){chai.assert.fail("do me")}); // TODO: This will be relaxed later on if the user is in a role that allows starting of other users games!
    //   white,
    it("should error out if white is null", function(){chai.assert.fail("do me")});
    //   black,
    it("should error out if black is null", function(){chai.assert.fail("do me")});
    //   wild_number,
    it("should error out if wild is not zero", function(){chai.assert.fail("do me")});
    //   rating_type,
    it("should error out if rating_type is not in the ICC configuration", function(){chai.assert.fail("do me")});
    //   rated,
    it("should error out if rated is not 'true' or 'false', and of course both of those work", function(){chai.assert.fail("do me")});
    //   white_initial,
    it("should error out if white_initial is null", function(){chai.assert.fail("do me")});
    it("should error out if white_initial is not a number", function(){chai.assert.fail("do me")});
    it("should error out if white_initial fails to meet the rules in ICC configuration", function(){chai.assert.fail("do me")});
    //   white_increment,
    it("should error out if white_increment is not a number", function(){chai.assert.fail("do me")});
    it("should error out if white_increment fails to meet the rules in ICC configuration", function(){chai.assert.fail("do me")});
    //   black_initial,
    it("should use white_initial if black_initial is null", function(){chai.assert.fail("do me")});
    it("should error out if black_initial is not a number", function(){chai.assert.fail("do me")});
    it("should error out if black_initial fails to meet the rules in ICC configuration", function(){chai.assert.fail("do me")});
    //   black_increment,
    it("should use white_increment if black_increment is null", function(){chai.assert.fail("do me")});
    it("should error out if black_increment is not a number", function(){chai.assert.fail("do me")});
    it("should error out if black_increment fails to meet the rules in ICC configuration", function(){chai.assert.fail("do me")});
    //   played_game /*,
    it("should error out if played_game is not 'true' or 'false'", function(){chai.assert.fail("do me")});
    it("should add an examined game to the database if played_game is false", function(){chai.assert.fail("do me")});
    it("should add a playing game to the database if played_game is true", function(){chai.assert.fail("do me")});
});
...
describe("Game.saveLegacyMove", function(){
    it("should error out if self is null", function(){chai.assert.fail("do me")});
    it("should error out if we don't have a game record", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds", function(){chai.assert.fail("do me")});
});
// Game.makeMove = function(self, game_id, move) {
describe("Game.makeMove", function(){
    it("should error out if self is null", function(){chai.assert.fail("do me")});
    it("should error out if a game cannot be found", function(){chai.assert.fail("do me")});
    it("should error out if an active game cannot be found", function(){chai.assert.fail("do me")});
    it("should write a client_message and not save the move to the dataabase if the move is illegal", function(){chai.assert.fail("do me")});
    it("should save the move to the dataabase if the move is legal", function(){chai.assert.fail("do me")});
    it("should end the game if the move results in a stalemate", function(){chai.assert.fail("do me")});
    it("should end the game if the move results in a checkmate", function(){chai.assert.fail("do me")});
    it("should end the game if the move results in an insufficient material draw", function(){chai.assert.fail("do me")});
    it("should not end the game if the move results in a draw by repetition situation", function(){chai.assert.fail("do me")});
    it("calls the move method of legacy user if it's a legacy game", function(){chai.assert.fail("do me")});
    it("does not check move validity if it's a legacy game (it lets the server do that.)", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("does not push an action when it succeeds as a legacy game (an incoming L2 will save this move)", function(){chai.assert.fail("do me")});
});
...
describe("Game.requestTakeback", function(){
    ...
    it("should error out if the game is examined", function(){chai.assert.fail("do me")});
    it("works on their move", function(){chai.assert.fail("do me")});
    it("works on their opponents move", function(){chai.assert.fail("do me")});
    it("fails and writes to client_messages if they are not in the 'request_takebacks' role", function(){chai.assert.fail("do me")});
    it("fails if number is null", function(){chai.assert.fail("do me")});
    it("fails if number is not a number", function(){chai.assert.fail("do me")});
    it("fails if number is less than 1", function(){chai.assert.fail("do me")});
    it("fails if number is greater than the limit in the ICC configuration", function(){chai.assert.fail("do me")});
    it("does not push an action if takeback fails", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("calls legacy user 'takeback' with the halfmove count if it's a legacy game", function(){chai.assert.fail("do me")});
    it("fails if game record indicates takebacks are not allowed", function(){chai.assert.fail("do me")});
});
...
describe("Game.acceptTakeback", function(){
    ...
    it("writes an action if there is a valid takeback accept", function(){chai.assert.fail("do me")});
    it("moves the chess.js moves back if it's a local game (prove with fen)", function(){chai.assert.fail("do me")});
    it("calls legacyuser takeback without parameters if it's a legacy game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("fails if there is a move by the acceptor in between", function(){chai.assert.fail("do me")});
    it("fails if there is a move by the requestor in between", function(){chai.assert.fail("do me")});
    it("succeeds if there if anything else in between (draw requests, kibitzes, anything other than a move.)", function(){chai.assert.fail("do me")});
});
...
describe("Game.declineTakeback", function(){
    ...
    it("calls legacyuser 'decline' if it's a legacy game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
});
...
describe("Game.requestDraw", function(){
    ...
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("calls legacy user 'draw' if it's a legacy game", function(){chai.assert.fail("do me")});
});
...
describe("Game.acceptDraw", function(){
    ...
    it("should error out if the game is examined", function(){chai.assert.fail("do me")});
    it("works on their move", function(){chai.assert.fail("do me")});
    it("fails on their opponents move", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("calls legacy user 'draw' if it's a legacy game", function(){chai.assert.fail("do me")});
});
...
describe("Game.declineDraw", function(){
    ...
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("calls legacy user 'decline' if it's a legacy game", function(){chai.assert.fail("do me")});
});
...
describe("Game.offerMoreTime", function(){
    ...
    it("pushes an action when it succeeds as a local game", function(){chai.assert.fail("do me")});
    it("pushes an action when it succeeds as a legacy game", function(){chai.assert.fail("do me")});
    it("calls legacy user 'moretime' if it's a legacy game", function(){chai.assert.fail("do me")});
});
