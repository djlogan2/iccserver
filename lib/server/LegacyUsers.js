...
function offers_in_my_game(data) {
  ...
  if (!!data.wtakeback || !!data.btakeback) {
      ...
      $set: {
        pending: {
          white: {
            abort: data.wabort,
            draw: data.wdraw,
            adjourn: data.wadjourn,
            takeback: { number: data.wtakeback, mid: data.message_identifier }
          },
          black: {
            abort: data.babort,
            draw: data.bdraw,
            adjourn: data.badjourn,
            takeback: { number: data.btakeback, mid: data.message_identifier }
          }
        }
      },
      $push: {
