...
// Visit a parse tree produced by PGNParser#brace_comment.
PGNVisitor.prototype.visitBrace_comment = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by PGNParser#numeric_annotation_glyph.
PGNVisitor.prototype.visitNumeric_annotation_glyph = function(ctx) {
  return this.visitChildren(ctx);
};
