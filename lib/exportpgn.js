...
export function exportGameObjectToPGN(game) {
  ...
  // TODO: OK, two things:
  //       1. First, I am pretty sure this works:
  //          !(game?.variations?.movelist?.[cmi]?.eco?.name === "NO_ECO") instead of this mess... :)
  //       2. Is this making sure it's providing the main line?
  if (
    !!game &&
    !!game.variations.movelist[cmi] &&
    !!game.variations.movelist[cmi].eco &&
    !!game.variations.movelist[cmi].eco.name &&
    !!game.variations.movelist[cmi].eco.code &&
    game.variations.movelist[cmi].eco.name !== "NO_ECO" &&
    game.variations.movelist[cmi].eco.code !== "NO_ECO"
  ) {
