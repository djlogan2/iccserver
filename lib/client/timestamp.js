...
Timestamp.getMilliseconds = function() {
  return new Date().getTime() - clock_offset / 2.0;
};
...
Meteor.startup(function() {
  ...
  protocol.on("opponent", function(data) {
    ...
    console.log("opponent " + opponents_userId + " has an average lag of " + opponents_average_lag + ", last ping=" + opponents_last_ping);
  });
