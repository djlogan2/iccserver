...
describe("Examine component", () => {
  ...
  it("should render with game observer", () => {
    ...
    Factory.define("importedGames", ImportedGameCollection, {
      _id: "fake_im_id",
      white: { id: "fake_white_id", name: "white" },
      black: { id: "fake_black_id", name: "black" },
    });
  ...
  it("should render with game examiner", () => {
    Factory.define("game", Game, {
      _id: "7BBXryAXwojBbKyHP",
      actions: [
        {
