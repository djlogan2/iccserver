  ...
  describe("exportToPGN", function() {
    it("Should promote pgn variations properly", function(){
      ...
      actions.forEach((action,index) => {
        ...
        pgn = exporter(null, our_game.variations.movelist, {movesonly: true});
    ...
    it("should export eco code and name of mainline instead of a variation", function() {
      ...
      pgnimporter.import(Game.exportToPGN(game_id));
      let actual_eco = pgnimporter.gamelist[0].tags['Opening'];
      let actual_code = pgnimporter.gamelist[0].tags['ECO'];
      ...
      pgnimporter.import(Game.exportToPGN(game_id));
      actual_eco = pgnimporter.gamelist[1].tags['Opening'];
      actual_code = pgnimporter.gamelist[1].tags['ECO'];
    ...
    it("should not send an eco code if we don't have eco defined", function(){
      ...
      let actual_eco = pgnimporter.gamelist[0].tags['Opening'];
      let actual_code = pgnimporter.gamelist[0].tags['ECO'];
      const our_pgn = Game.exportToPGN(game_id);
