...
describe("GamePublisher", function () {
  ...
  it.skip("should not look up a record in the database if there NOT any left over added fields", function () {
    chai.assert.fail("do me");
  });
  // getUpdatedRecord(id, rec)
  it.skip("should not null deleted fields if the type does not change", function () {
    chai.assert.fail("do me");
  });
  it.skip("should not add fields if the type does not change", function () {
    chai.assert.fail("do me");
  });
});
