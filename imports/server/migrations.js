...
import clientInternationalization from "../collections/clientInternationalization";
...
Meteor.startup(() => {
  ...
  Migrations.add({
    version: "0.3.30_2",
    name: "Update client i18n for en locales v 0.21",
    run: () => {
      mongoClientInternationalization.update({ locale: "en-us" }, { $set: { i18n: english } });
    },
  });
  ...
  Migrations.add({
    version: "0.3.30_5",
    name: "Update client i18n for en locales v 0.22",
    run: () => {
      mongoClientInternationalization.update({ locale: "en-us" }, { $set: { i18n: english } });
    },
  });
  ...
  Migrations.add({
    version: "0.3.30_10",
    name: "Update client i18n for en locales v 0.26",
    run: () => {
      mongoClientInternationalization.update({ locale: "en-us" }, { $set: { i18n: english } });
    },
  });
