...
export const PlayedGameSchema = new SimpleSchema({
  ...
  "variations.movelist.$.eco": { type: Object, required: false },
  "variations.movelist.$.eco.name": { type: String, required: false },
  "variations.movelist.$.eco.code": { type: String, required: false },
  "variations.movelist.$.wcurrent": { type: Number, required: false },
  "variations.movelist.$.bcurrent": { type: Number, required: false },
