...
export default class PlayerTop extends Component {
  ...
  render() {
    ...
    let blackPlayerTime = PlayerTop.gametimeUpdate(propsTime);
        ...
        <div className="board-player-top">
          ...
          <div className="board-player-userTagline">
            ...
            <div className="captured-pieces">
              <img src="images/small-picW-1.png" />{" "}
              <img src="images/small-picW-2.png" />
            </div>

            <div className="clock-top">{blackPlayerTime}</div>
          </div>
        </div>
      </div>
    );
