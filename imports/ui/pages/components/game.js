    ...
    handleClick(i) {
        ...
        if (this.state.sourceSelection === -1) {
            ...
            if (squares[i] && squares[i].player === this.state.player) {
                ...
                const isMovePossible = Bishop.isMovePossible(this.state.sourceSelection, i, isDestEnemyOccupied);
                const srcToDestPath = Bishop.getSrcToDestPath(this.state.sourceSelection, i);
