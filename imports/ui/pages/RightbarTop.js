        ...
        <Tabs>
            ...
            <div label="Game" cover="../../../images/game-icon-gray.png">
                ...
                <div className="game-move-list">
                    <span>1.</span> e4 d5 <span>2.</span> exd5 b5 <span>3.</span> c3 c6 <span>4.</span> dxc6
                    b4 <span>5.</span> ce2 a6 <span>6.</span> d4 a7
                    <span>7.</span> c3 b7 <span>8.</span> cxb7 xb7 <span>9.</span> f4 xd4 <span>10.</span> xd4
                    e5 <span>11.</span> xe5
                            ...
                            <div className="panel panel-default">
                                <div className="panel-heading">
                                    <h4 className="panel-title">
                                        <span>[</span> <a data-toggle="collapse" data-parent="#accordion"
                                                          href="#collapseOne1" className="minus collapsed">&nbsp;</a>
                                    </h4>
                                </div>
                    ...
                    <span>12</span>...bxa3 <span>13.</span>Qxa3 Qb8 <span>14.</span> Rfd1 Ra7 <span>15.</span> b3
                    Rb7 <span>16.</span> Rab1
                ...
                <div className="draw-section">
                    <ul>
                        <li><a href="#" title="Takeback"><span><img src="images/take-forward-icon.png"/></span>Takeback</a>
                        </li>
                ...
                <div className="play-tab-content">
                    <nav>
                        <div className="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <ul>
                                <li><span>Time</span><a className="nav-item nav-link active" id="nav-home-tab"
                                                        data-toggle="tab" href="#nav-time" role="tab"
                                                        aria-controls="nav-home" aria-selected="true">10 min <i
                                    className="fa fa-sort-down" aria-hidden="true"></i></a></li>
                                <li><span>Type</span><a className="nav-item nav-link" id="nav-profile-tab"
                                                        data-toggle="tab" href="#nav-type" role="tab"
                                                        aria-controls="nav-profile" aria-selected="false"><img
                                    src="images/type-icon.png" alt=""/> <i className="fa fa-sort-down"
                                                                           aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </nav>
                    <div className="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div className="tab-pane fade show active" id="nav-time" role="tabpanel"
