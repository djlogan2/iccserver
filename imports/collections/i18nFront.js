...
i18nFrontCollection.attachSchema(i18nSchema);
...
i18n.localizeMessage = function(locale, i18nvalue, parameters) {
  const i8nrecord = i18nFrontCollection.findOne({
    messageid: i18nvalue
  });
...
Meteor.publish("i18n_front", function() {
    return i18nFrontCollection.find({ to: this.userId });
});


export default i18nFrontCollection;
...
Meteor.startup(function() {
  if (Meteor.isTest || Meteor.isAppTest) i18n.collection = i18nFrontCollection;
});
